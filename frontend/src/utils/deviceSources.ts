...
export type SourceBucket = 'ip' | 'zigbee' | 'zwave' | 'proxmox' | 'unifi' | 'xcpng' | 'rack' | 'canvas'
...
const SOURCE_ORDER: SourceBucket[] = ['ip', 'proxmox', 'unifi', 'xcpng', 'zigbee', 'zwave', 'rack', 'canvas']
